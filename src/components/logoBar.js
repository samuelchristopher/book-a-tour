    ...
    <div className={style.logobar__bg}>
        <div className={style.logobar__container}>
            ...
            <div className={style.social__container}>
                <a target="_blank" href="https://www.facebook.com/gracetravelbrunei/" className={style.social__fb}></a>
                <a target="_blank" href="http://www.instagram.com/gracebrunei/" className={style.social__ig}></a>
            </div>
        </div>
    </div>
)
